...
export interface ApiBlogPostBlogPost extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Blog posts with draft/published state';
  ...
  attributes: {
    ...
    coverImageUrl: Schema.Attribute.String & Schema.Attribute.DefaultTo<''>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
export interface ApiProgressProgress extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Tracks lesson completion per student per course';
...
export interface ApiQuizAttemptQuizAttempt extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: "A student's quiz submission with auto-graded score";
...
export interface ApiQuizQuiz extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'MCQ quiz for a course';
    displayName: 'Quiz';
    pluralName: 'quizzes';
    singularName: 'quiz';
  };
